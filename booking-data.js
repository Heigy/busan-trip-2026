window.BOOKING_DATA = {
  bookings: [
    ...
    {
      id: "jeju-hotel",
      stopIds: ["j1-1a", "j2-0", "j4-1"],
      region: "jeju",
      dayId: "jeju-d1",
      status: "confirmed",
      date: "2026-08-04",
      dateLabel: { zh: "8月4–7日 · 三晚", en: "Aug 4–7 · 3 nights" },
      time: { zh: "入住 15:00 後 · 退房 12:00 前", en: "Check-in after 15:00 · Check-out before 12:00" },
      title: {
        zh: "濟州太平洋酒店（憑證 1／2）",
        en: "Jeju Pacific Hotel (voucher 1/2)",
      },
      titleKo: "제주퍼시픽호텔",
      platform: "Trip.com / 攜程",
      orderNo: "1128149699160234",
      voucherNo: "1128149699160234",
      qty: { zh: "豪華雙床房 × 1 間 · 3 晚", en: "Deluxe Twin × 1 · 3 nights" },
      lead: "Ying / Hei Tung",
      travelers: ["Ying/Hei Tung"],
      howToUse: {
        zh: "憑確認號辦理入住 · 官方入住時間為當地 15:00 後 · 同行另有 2 間見下一張憑證",
        en: "Check in with confirmation no. · after 15:00 local · 2 more rooms on the next voucher",
      },
      address: {
        zh: "濟州市 西士路 20（龍潭1洞 · 郵編 63174）",
        en: "20 Seosa-ro, Yongdam 1-dong, Jeju City 63174",
      },
      note: {
        zh: "含 8/5–7 雙人早餐 · 1 雙+1 單 · 已付 CNY 1,536 · 全團共 3 間（本憑證 1 間）",
        en: "Breakfast for 2 on Aug 5–7 · 1 double + 1 single · paid CNY 1,536 · 3 rooms total (1 on this voucher)",
      },
      link: null,
      website: "http://www.jejupacific.co.kr/",
      phone: "+82-64-758-2500",
      amount: "CNY 1,536.00",
    },
    {
      id: "jeju-hotel-2",
      ...
      title: {
        zh: "濟州太平洋酒店（憑證 2／2）",
        en: "Jeju Pacific Hotel (voucher 2/2)",
      },
      titleKo: "제주퍼시픽호텔",
      platform: "Trip.com / 攜程",
      orderNo: "1128149699160233",
      voucherNo: "1128149699160233",
      qty: { zh: "豪華雙床房 × 2 間 · 3 晚", en: "Deluxe Twin × 2 · 3 nights" },
      lead: "NG / Yi Hin",
      travelers: ["NG/Yi Hin", "Ng/Sum Yu"],
      howToUse: {
        zh: "憑確認號辦理入住 · 每房 1 雙+1 單、最多 3 人 · 與憑證 1 同酒店",
        en: "Check in with confirmation no. · 1 double + 1 single per room, max 3 · same hotel as voucher 1",
      },
      address: {
        zh: "濟州市 西士路 20（龍潭1洞 · 郵編 63174）",
        en: "20 Seosa-ro, Yongdam 1-dong, Jeju City 63174",
      ...
      note: {
        zh: "含 8/5–7 共 6 份早餐（2 間）· 已付 CNY 4,122 · 全團共 3 間（本憑證 2 間）",
        en: "6 breakfasts for 2 rooms on Aug 5–7 · paid CNY 4,122 · 3 rooms total (2 on this voucher)",
      },
      link: null,
      website: "http://www.jejupacific.co.kr/",
      phone: "+82-64-758-2500",
